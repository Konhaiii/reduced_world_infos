...
#show infos
execute if entity @s[tag=!reduced_world_infos-logbook_calibrated,tag=!reduced_world_infos-logbook_altimeter] run title @s actionbar [{"text":"X: ","color":"white"},{"nbt":"posX","storage":"reduced_world_infos","color":"red"},{"text":" Z: ","color":"white"},{"nbt":"posZ","storage":"reduced_world_infos","color":"red"}]
execute if entity @s[tag=reduced_world_infos-logbook_calibrated,tag=!reduced_world_infos-logbook_altimeter] run title @s actionbar [{"text":"X: ","color":"white"},{"nbt":"posX","storage":"reduced_world_infos","color":"yellow"},{"text":" Z: ","color":"white"},{"nbt":"posZ","storage":"reduced_world_infos","color":"yellow"}]
execute if entity @s[tag=!reduced_world_infos-logbook_calibrated,tag=reduced_world_infos-logbook_altimeter] run title @s actionbar [{"text":"X: ","color":"white"},{"nbt":"posX","storage":"reduced_world_infos","color":"red"},{"text":" Y: ","color":"white"},{"nbt":"posY","storage":"reduced_world_infos","color":"yellow"},{"text":" Z: ","color":"white"},{"nbt":"posZ","storage":"reduced_world_infos","color":"red"}]
execute if entity @s[tag=reduced_world_infos-logbook_calibrated,tag=reduced_world_infos-logbook_altimeter] run title @s actionbar [{"text":"X: ","color":"white"},{"nbt":"posX","storage":"reduced_world_infos","color":"yellow"},{"text":" Y: ","color":"white"},{"nbt":"posY","storage":"reduced_world_infos","color":"yellow"},{"text":" Z: ","color":"white"},{"nbt":"posZ","storage":"reduced_world_infos","color":"yellow"}]
