...
execute if items entity @s weapon.mainhand reduced_world_infos:logbook run item modify entity @s weapon.mainhand reduced_world_infos:logbook_upgrade/altimeter
...
execute if items entity @s weapon.offhand reduced_world_infos:logbook run item modify entity @s weapon.offhand reduced_world_infos:logbook_upgrade/altimeter
