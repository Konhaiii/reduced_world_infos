...
advancement grant @s only reduced_world_infos:adventure/calibrate_logbook
...
execute if items entity @s weapon.mainhand reduced_world_infos:logbook run item modify entity @s weapon.mainhand reduced_world_infos:logbook_upgrade/calibration_shard
...
execute if items entity @s weapon.offhand reduced_world_infos:logbook run item modify entity @s weapon.offhand reduced_world_infos:logbook_upgrade/calibration_shard
